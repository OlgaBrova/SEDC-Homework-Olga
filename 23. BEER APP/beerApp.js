function BeerApp() {
    ...
    this.init = function() {
        ...
        this.pageSizeBtn.addEventListener("click", (event) => {
            ...
            let pageSize = event.target.id;
            //console.log(pageSize);
         
            this.dataProcessingService.beerPagination(this.currentPage, pageSize, this.result);
            

            // OVDE NE MI DAVA MAX PAGES IAKO GI DOBIVAM SO FUNKCIJATA VO dataProcessingService.getMaxPages. PROBUVAM SO CONSOLE LOG AMA UNDEFINED MI SE OVDE. NE ZNAM KADE GRESHAM

            this.maxPages = this.dataProcessingService.getMaxPages(pageSize);
...
function DataProcessingService() {
    ...
    // EVE JA FUNKCIJATA ZA MAX PAGES (OVDE E VO RED NO NE MI GI DAVA GORE KADE SHTO MI TREBA BROJOT NA MAX STRANI)
